...
3. Each folder should place all image files in a subfolder called `assets` (When you do this, you will need to modify the starter code to access these files) (note to self: having trouble figuring out how to do this 3rd part, ask bander when he comes back)
